...
public class VoucherService extends PersistenceService<CVoucherHeader, Long> {
	...
	public CVoucherHeader getUpdatedVNumCGVN(final CVoucherHeader existingVH, final CVoucherHeader voucherHeader,
		...
		autoVoucherType = existingVH.getVoucherNumber().substring(
				Integer.parseInt(getVoucherNumberFormatPrefix(FinancialConstants.VOUCHERNO_TYPE_LENGTH))
						- Integer.parseInt(getVoucherNumberFormatPrefix(FinancialConstants.VOUCHERNO_TYPE_SUBLENGTH)),
				Integer.parseInt(getVoucherNumberFormatPrefix(FinancialConstants.VOUCHERNO_TYPE_LENGTH)));
		if (LOGGER.isDebugEnabled())
		...
		try {
			...
			// manual voucher number
					...
					&& !existingVH.getVoucherNumber()
							.substring(
									Integer.valueOf(getVoucherNumberFormatPrefix(FinancialConstants.VOUCHERNO_TYPE_LENGTH)))
	...
	public Map<String, Object> getDesgByDeptAndType(final String type, final String scriptName) {
		 ...
		 * HashMap<String, Object>(); if(LOGGER.isDebugEnabled()) LOGGER.debug(
