...
public class VoucherHelper {
	...
	public static String sequenceNameFor(final String voucherType, final String fiscalPeriodName) {
		return new StringBuilder().append(DEFAULT_SEQUENCE_PREFIX).append(voucherType)
				.append(ApplicationSequenceNumberGenerator.WORD_SEPARATOR_FOR_NAME).append(fiscalPeriodName).toString();
	}
	...
	public String getGeneratedVoucherNumber(final Integer fundId, String voucherType, final Date voucherDate,
		...
		if (vNumGenMode.equalsIgnoreCase("Auto")) {
			...
			final ScriptContext scriptContext = ScriptService.createContext("fundIdentity", fundIdentifier,
					...
					dbSequenceGenerator, "sequenceNumberGenerator", applicationSequenceNumberGenerator, "voucherNumber",
	...
	public String getVoucherFormatPrefix(String keyName) {
		try {
