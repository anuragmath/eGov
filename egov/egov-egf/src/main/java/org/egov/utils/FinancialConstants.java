...
public interface FinancialConstants {
	...
	public static final String RECEIPT_VOUCHERNO_TYPE = "receipt";
	public static final String PAYMENT_VOUCHERNO_TYPE = "payment";
	public static final String JOURNAL_VOUCHERNO_TYPE = "journal";
	public static final String CONTRA_VOUCHERNO_TYPE = "contra";
	public static final String PURCHBILL_VOUCHERNO_TYPE = "purchasejv";
	public static final String WORKSBILL_VOUCHERNO_TYPE = "worksjv";
	public static final String FIXEDASSET_VOUCHERNO_TYPE = "fixedassetjv";
	public static final String SALBILL_VOUCHERNO_TYPE = "salaryjv";
	public static final String PENBILL_VOUCHERNO_TYPE = "pensionjv";
	public static final String CBILL_VOUCHERNO_TYPE = "contingentjv";
	public static final String ADVANCEBILL_VOUCHERNO_TYPE = "advance";

	public static final String VOUCHERNO_TYPE_LENGTH = "length";
	public static final String VOUCHERNO_TYPE_SUBLENGTH = "sublength";
