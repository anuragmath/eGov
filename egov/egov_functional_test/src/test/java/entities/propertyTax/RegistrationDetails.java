...
public class RegistrationDetails {
    ...
    public void setRegisteredPlinthArea(String registeredPlinthArea) {this.registeredPlinthArea = registeredPlinthArea;}
    ...
    public void setRegistrationDocumentNumber(String registrationDocumentNumber) {this.registrationDocumentNumber = registrationDocumentNumber;}

    public String getRegistrationDocumentDate() {
        return registrationDocumentDate;
    }

    public void setRegistrationDocumentDate(String registrationDocumentDate) {this.registrationDocumentDate = registrationDocumentDate;}

    public String getPartiesConsiderationValue() {
        return partiesConsiderationValue;
    }

    public void setPartiesConsiderationValue(String partiesConsiderationValue) {this.partiesConsiderationValue = partiesConsiderationValue;}

    public String getDepartmentGuidelinesValue() {
        return departmentGuidelinesValue;
    }

    public void setDepartmentGuidelinesValue(String departmentGuidelinesValue) {this.departmentGuidelinesValue = departmentGuidelinesValue;}
}
