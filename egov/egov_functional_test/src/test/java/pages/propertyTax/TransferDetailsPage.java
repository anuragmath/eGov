...
public class TransferDetailsPage extends BasePage {
    ...
    public void enterEnclosureDetails() {
        ...
        document1.sendKeys(System.getProperty("user.dir") + "/src/test/resources/propertyTaxTestData.xlsx");
        WebElement document2 = webdriver.findElement(By.id("save_documents_1__uploads"));
        document2.sendKeys(System.getProperty("user.dir") + "/src/test/resources/propertyTaxTestData.xlsx");
        WebElement document3 = webdriver.findElement(By.id("save_documents_2__uploads"));
        document3.sendKeys(System.getProperty("user.dir") + "/src/test/resources/propertyTaxTestData.xlsx");
        WebElement document4 = webdriver.findElement(By.id("save_documents_3__uploads"));
        document4.sendKeys(System.getProperty("user.dir") + "/src/test/resources/propertyTaxTestData.xlsx");
    }
