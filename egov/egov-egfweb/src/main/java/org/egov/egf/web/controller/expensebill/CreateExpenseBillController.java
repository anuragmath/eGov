...
public class CreateExpenseBillController extends BaseBillController {
	...
	public String showNewForm(@ModelAttribute("egBillregister") final EgBillregister egBillregister,
			final Model model) {
	...
	private String generateMessage(EgBillregister egBillregister, WorkflowBean workflowBean) {
		...
		case WorkflowConstants.ACTION_FORWARD:
			message = messageSource.getMessage(
					"msg.expense.bill.create.success", new String[] { egBillregister.getBillnumber(),
	...
	private void fillOnErrors(final EgBillregister egBillregister, final Model model, HttpServletRequest request,
	...
	public String showSuccessPage(final Model model, final HttpServletRequest request) {
